    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-info">
            <div class="box-body box-profile" style="color: #D4AF37;">
              ...
              <?php
                  // User rating
                  $query = "SELECT * FROM ratings WHERE eventID=".$eventID." and userID=".$_SESSION['userID'];
          ...
          <?php
              $stmt = $conn->prepare("SELECT * FROM attendance WHERE rollNum=? AND eventID=?");
              $stmt->bind_param("ss", $user['rollNum'], $_GET['eventID']);
              $stmt->execute();
              $stmt->store_result();
              $numAt = $stmt->num_rows;
              $stmt->close();
          ...
          <div class="box box-info text-center">
            <div class="box-body box-profile" style="color: #D4AF37;">
              <div class="box-header with-border">
                <h3 class="box-title">Rate this Event</h3>
              </div>
              <!-- Rating -->
              <select class='rating' id='rating_<?php echo $eventID; ?>' data-id='rating_<?php echo $eventID; ?>'>
          ...
          <?php
              ...
              echo "As you have not attended the event, you cannot rate it";
            }
          ?>
        ...
        <div class="col-md-9">
          ...
          ?>
          <div class="row">
              <form class="form-horizontal" method="post" action="addReview.php" id="changePass">
                    <div class="col-sm-11">
                      <textarea rows="1" class="form-control" id="inputReview" placeholder="Review this event" style="resize: none;" name="review"></textarea>
                    </div>
                    <input type="text" name="eventID" value="<?php echo $eventID; ?>" hidden>
                    <div class="col-sm-1">
                      <button type="submit" class="btn btn-info" name="reviewEvent">
          ...
          <?php
              ...
              echo "As you have not attended the event, you cannot review it";
            }
          ?>
        <!-- /.col -->
      </div>
